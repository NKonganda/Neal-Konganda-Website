...
- `src/lib/network.js` — Pure Canvas 2D network helpers: COLORS, CONFIG (85 base nodes, lineOpacity 0.11, wander+maxSpeed for organic drift), nodeCountFor, buildNodes, stepNodes (random-walk velocity nudge + speed clamp), drawNetwork (~180 tokens)
